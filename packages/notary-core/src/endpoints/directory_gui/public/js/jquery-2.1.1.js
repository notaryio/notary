...
!(function(a, b) {
  ...
  (n.fn = n.prototype = {
    ...
    makeArray: function(a, b) {
      var c = b || [];
      return null != a &&
        (s(Object(a)) ? n.merge(c, 'string' == typeof a ? [a] : a) : f.call(c, a)), c;
    },
  ...
  var t = (function(a) {
    ...
    function fb(a, b, d, e) {
      ...
      if (
        ((b ? b.ownerDocument || b : v) !== n && m(b), (b = b || n), (d = d || []), !a ||
          'string' != typeof a)
      )
        return d;
    ...
    (c = fb.support = {}), (f = fb.isXML = function(a) {
      ...
      return e !== n && 9 === e.nodeType && e.documentElement
        ? ((n = e), (o = e.documentElement), (p = !f(e)), g &&
            ...
            r.length && new RegExp(r.join('|'))), (b = $.test(o.compareDocumentPosition)), (t = b ||
            $.test(o.contains)
            ? function(a, b) {
      ...
      if (
        ((a.ownerDocument || a) !== n && m(a), (b = b.replace(U, "='$1']")), !(!c.matchesSelector ||
          !p ||
          (r && r.test(b)) ||
          (q && q.test(b))))
      )
        ...
        CHILD: function(a) {
          return (a[1] = a[1].toLowerCase()), 'nth' === a[1].slice(0, 3)
            ? (a[3] || fb.error(a[0]), (a[4] = +(a[4]
                ? a[5] + (a[6] || 1)
                : 2 * ('even' === a[3] || 'odd' === a[3]))), (a[5] = +(a[7] + a[8] ||
                'odd' === a[3])))
            : a[3] && fb.error(a[0]), a;
        },
        PSEUDO: function(a) {
    ...
    (pb.prototype = d.filters = d.pseudos), (d.setFilters = new pb()), (g = fb.tokenize = function(
      ...
      while (h) {
        (!c || (e = S.exec(h))) &&
          ...
          ((c = e.shift()), f.push({ value: c, type: e[0].replace(R, ' ') }), (h = h.slice(
            c.length
          )));
        for (g in d.filter)
          !(e = X[g].exec(h)) ||
  ...
  function P(a, b, c) {
    ...
    if (void 0 === c && 1 === a.nodeType)
      if (
        ((d = 'data-' + b.replace(O, '-$1').toLowerCase()), (c = a.getAttribute(d)), 'string' ==
          typeof c)
      ) {
        try {
          c = 'true' === c
    ...
    domManip: function(a, b) {
      ...
      if (
        ...
        for ((f = n.map(ob(c, 'script'), kb)), (g = f.length); l > j; j++)
          (h = c), j !== o && ((h = n.clone(h, !0, !0)), g && n.merge(f, ob(h, 'script'))), b.call(
            this[j],
            h,
            j
          );
    ...
    return c ||
      ((c = sb(a, b)), ('none' !== c && c) ||
        ((qb = (qb || n("<iframe frameborder='0' width='0' height='0'/>"))
          .appendTo(b.documentElement)), (b = qb[0].contentDocument), b.write(), b.close(), (c = sb(
          a,
          b
        )), qb.detach()), (rb[a] = c)), c;
  }
  ...
  n.extend({
    ...
    css: function(a, b, c, d) {
      ...
      return (b = n.cssProps[h] || (n.cssProps[h] = Fb(a.style, h))), (g =
        n.cssHooks[b] || n.cssHooks[h]), g && 'get' in g && (e = g.get(a, !0, c)), void 0 === e &&
        (e = xb(a, b, d)), 'normal' === e && b in Db && (e = Db[b]), '' === c || c
  ...
  function Vb(a, b, c) {
    ...
    c.queue ||
      ...
      ((c.overflow = [o.overflow, o.overflowX, o.overflowY]), (j = n.css(
        a,
        'display'
      )), (k = 'none' === j ? L.get(a, 'olddisplay') || tb(a.nodeName) : j), 'inline' === k &&
        'none' === n.css(a, 'float') &&
  ...
  (n.Animation = n.extend(Xb, {
    ...
    return (d.duration = n.fx.off
      ...
      : 'number' == typeof d.duration
          ? d.duration
          : d.duration in n.fx.speeds ? n.fx.speeds[d.duration] : n.fx.speeds._default), (null ==
      d.queue ||
      d.queue === !0) &&
    ...
    finish: function(a) {
      return a !== !1 && (a = a || 'fx'), this.each(function() {
        var b,
          ...
          g = d ? d.length : 0;
        for (
          (c.finish = !0), n.queue(this, a, []), e && e.stop && e.stop.call(this, !0), (b =
            f.length);
          b--;
  ...
  n.fn.extend({
    ...
    attr: function(a, b, c) {
      ...
      if (a && 3 !== f && 8 !== f && 2 !== f)
        return typeof a.getAttribute === U
          ...
          : ((1 === f && n.isXMLDoc(a)) ||
              ((b = b.toLowerCase()), (d =
                n.attrHooks[b] || (n.expr.match.bool.test(b) ? Zb : Yb))), void 0 === c
    ...
    $b[b] = function(a, b, d) {
      var e, f;
      return d ||
        ((f = $b[b]), ($b[b] = e), (e = null != c(a, b, d) ? b.toLowerCase() : null), ($b[
          b
        ] = f)), e;
    };
  });
            ...
            n.isFunction(a)
              ...
              : function() {
                  if ('string' === c) {
                    ...
                    (c === U || 'boolean' === c) &&
                      (this.className &&
                        L.set(this, '__className__', this.className), (this.className = this
                        .className || a === !1
                        ? ''
  ...
  n.extend({
    ...
    ajax: function(a, b) {
      ...
      if (
        ((o.promise(v).complete = p.add), (v.success = v.done), (v.error = v.fail), (k.url = ((a ||
          k.url ||
          fc) + '')
          .replace(gc, '')
          .replace(lc, ec[1] + '//')), (k.type =
          b.method || b.type || k.method || k.type), (k.dataTypes = n
          .trim(k.dataType || '*')
          .toLowerCase()
      ...
      (i = k.global), i &&
        0 === n.active++ &&
        n.event.trigger('ajaxStart'), (k.type = k.type.toUpperCase()), (k.hasContent = !kc.test(
        k.type
        ...
        (n.lastModified[d] && v.setRequestHeader('If-Modified-Since', n.lastModified[d]), n.etag[
          d
      ...
      function x(a, b, f, h) {
        ...
        2 !== t &&
          ((t = 2), g && clearTimeout(g), (c = void 0), (e = h || ''), (v.readyState = a > 0
            ? 4
            : 0), (j = (a >= 200 && 300 > a) || 304 === a), f && (u = uc(k, v, f)), (u = vc(
            k,
            u,
            v,
            j
            ...
            m.trigger(j ? 'ajaxSuccess' : 'ajaxError', [v, k, j ? r : s]), p.fireWith(l, [
            v,
            x
  ...
  (n.param = function(a, b) {
    ...
    if (
      (void 0 === b && (b = n.ajaxSettings && n.ajaxSettings.traditional), n.isArray(a) ||
  ...
  a.ActiveXObject &&
    ...
    }), (k.cors = !!Fc && 'withCredentials' in Fc), (k.ajax = Fc = !!Fc), n.ajaxTransport(function(
    a
  ) {
    var b;
      ...
      ? {
          send: function(c, d) {
            ...
            (b = function(a) {
              return function() {
                b &&
                  (delete Dc[g], (b = f.onload = f.onerror = null), 'abort' === a
                    ? f.abort()
                    : 'error' === a
  ...
  n.ajaxSetup({
    ...
    return h || 'jsonp' === b.dataTypes[0]
      ? ((e = b.jsonpCallback = n.isFunction(b.jsonpCallback)
          ...
          : b.jsonp !== !1 &&
              (b.url += (dc.test(b.url) ? '&' : '?') + b.jsonp + '=' + e), (b.converters[
          'script json'
        ] = function() {
    ...
    return d
      ? [b.createElement(d[1])]
      : ((d = n.buildFragment([a], b, e)), e && e.length && n(e).remove(), n.merge(
          [],
          d.childNodes
        ));
  });
