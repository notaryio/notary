...
!(function(a, b) {
  (a.MixItUp = function() {
    ...
    _addHook: function(b, c, d, e, f) {
      ...
      (f = 1 === f || 'post' === f ? 'post' : 'pre'), (h[c] = {}), (h[c][f] = {}), (h[c][f][
        d
      ] = e), a.extend(!0, g, h);
    },
    _init: function(b, c) {
      var d = this;
      if (
        (d._execAction('_init', 0, arguments), c && a.extend(!0, d, c), (d._$body = a(
          'body'
        )), (d._domNode = b), (d._$container = a(b)), d._$container.addClass(
          d.layout.containerClass
        ), (d._id = b.id), d._platformDetect(), (d._brake = d._getPrefixedCSS(
          'transition',
          'none'
        )), d._refresh(!0), (d._$parent = d._$targets.parent().length
          ? d._$targets.parent()
          : d._$container), d.load.sort &&
          ((d._newSort = d._parseSort(d.load.sort)), (d._newSortString =
            d.load.sort), (d._activeSort =
            d.load.sort), d._sort(), d._printSort()), (d._activeFilter = 'all' === d.load.filter
          ? d.selectors.target
          : 'none' === d.load.filter ? '' : d.load.filter), d.controls.enable &&
          d._bindHandlers(), d.controls.toggleFilterButtons)
      ) {
        d._buildToggleArray();
    ...
    _platformDetect: function() {
      var a = this,
        ...
        h = g(a._domNode);
      a._execAction('_platformDetect', 0), (a._chrome = e ? parseInt(e[1], 10) : !1), (a._ff = f
        ? parseInt(window.navigator.userAgent.match(/rv:([^)]+)\)/)[1])
        : !1), (a._prefix = h.prefix), (a._vendor = h.vendor), (a._suckMode = window.atob &&
        a._prefix
        ? !1
    ...
    _bindHandlers: function() {
      ...
      c._execAction('_bindHandlers', 0), c.controls.live
        ? c._$body
        ...
        : ((c._$sortButtons = a(c.selectors.sort)), (c._$filterButtons = a(
            c.selectors.filter
        ...
        ? 1
        : d[c.selectors.filter] + 1), (e[c.selectors.sort] = e[c.selectors.sort] === b
        ? 1
        : e[c.selectors.sort] + 1), c._execAction('_bindHandlers', 1);
    },
      ...
      var e = this,
        f = function(c, d, f) {
          ...
          (g._handled['_' + d][e.selectors[d]] = g._handled['_' + d][e.selectors[d]] === b
            ? 1
            : g._handled['_' + d][e.selectors[d]] + 1), g._handled['_' + d][e.selectors[d]] ===
            g._bound['_' + d][e.selectors[d]] &&
            (c[(f ? 'remove' : 'add') + 'Class'](e.controls.activeClass), delete g._handled[
              '_' + d
            ][e.selectors[d]]);
        };
      if (
        (e._execAction('_processClick', 0, arguments), !e._mixing ||
        ...
        'function' == typeof e.callbacks.onMixBusy &&
          e.callbacks.onMixBusy.call(e._domNode, e._state, e), e._execAction(
          '_processClickBusy',
          1,
          arguments
        );
    ...
    _updateControls: function(c, d) {
      ...
      e._execAction('_updateControls', 0, arguments), c.filter === b &&
        (f.filter = e._activeFilter), c.sort === b && (f.sort = e._activeSort), f.filter ===
        e.selectors.target && (f.filter = 'all');
      for (var j = 0; 2 > j; j++)
        (i = e.controls.live ? a(e.selectors[h]) : e['_$' + h + 'Buttons']), i &&
    ...
    _printSort: function(a) {
      ...
      for (var g = 0; g < d.length; g++) {
        ...
        'absolute' !== h.style.position &&
          (i && '#text' === i.nodeName && b._$parent[0].removeChild(i), b._$parent[0].removeChild(
            h
          ));
      }
    ...
    _parseSort: function(a) {
      for (
        var b = this, c = 'string' == typeof a ? a.split(' ') : [a], d = [], e = 0;
        e < c.length;
        e++
      ) {
    ...
    _parseEffects: function() {
      ...
      return (b.opacity = c('fade') ? c('fade', !0).val || '0' : '1'), e('transformIn'), a.animation
        .reverseOut
        ? e('transformOut', !0)
        : (b.transformOut = b.transformIn), (b.transition = {}), (b.transition = a._getPrefixedCSS(
        'transition',
        'all ' +
          ...
          a.animation.duration +
          'ms linear'
      )), (a.animation.stagger = c('stagger') ? !0 : !1), (a.animation.staggerDuration = parseInt(
        c('stagger') ? (c('stagger', !0).val ? c('stagger', !0).val : 100) : 100
    ...
    _goMix: function(a) {
      var b = this,
        ...
        d = function() {
          ...
          document.documentElement
            .scrollHeight, b._getInterMixData(), b._setFinal(), b._getFinalMixData(), window.pageYOffset !==
      ...
      b._execAction('_goMix', 0, arguments), !b.animation.duration &&
        ...
        b.callbacks.onMixStart.call(b._domNode, b._state, g, b), b._$container.trigger('mixStart', [
        b._state,
        g,
        b
    ...
    _getTargetData: function(a, b) {
      var c, d = this;
      (a.dataset[b + 'PosX'] = a.offsetLeft), (a.dataset[b + 'PosY'] = a.offsetTop), d.animation
        .animateResizeTargets &&
        ((c = window.getComputedStyle(a)), (a.dataset[b + 'MarginBottom'] = parseInt(
          c.marginBottom
        )), (a.dataset[b + 'MarginRight'] = parseInt(c.marginRight)), (a.dataset[b + 'Width'] =
    ...
    _getOrigMixData: function() {
      ...
      (a._incPadding = 'border-box' === c), a._execAction('_getOrigMixData', 0), !a._suckMode &&
        (a.effects = a._parseEffects()), (a._$toHide = a._$hide.filter(
        ':visible'
      )), (a._$toShow = a._$show.filter(':hidden')), (a._$pre = a._$targets.filter(
        ':visible'
    ...
    _setInter: function() {
      ...
      a._execAction('_setInter', 0), a._changingLayout && a.animation.animateChangeLayout
        ? (a._$toShow.css('display', a._newDisplay), a._changingClass &&
            a._$container.removeClass(a.layout.containerClass).addClass(a._newClass))
        : a._$toShow.css('display', a.layout.display), a._execAction('_setInter', 1);
    },
    ...
    _setFinal: function() {
      ...
      a._execAction('_setFinal', 0), a._sorting && a._printSort(), a._$toHide.removeStyle(
        ...
        a._$pre.css('display', a._newDisplay), a._execAction('_setFinal', 1);
    },
    _getFinalMixData: function() {
      ...
      (a._newHeight = a._incPadding ? a._$parent.outerHeight() : a._$parent.height()), a._sorting &&
        a._printSort(!0), a._$toShow.removeStyle('display'), a._$pre.css(
        'display',
        a.layout.display
      ), a._changingClass &&
        a.animation.animateChangeLayout &&
        a._$container.removeClass(a._newClass).addClass(a.layout.containerClass), a._execAction(
        '_getFinalMixData',
        1
      );
    },
    _prepTargets: function() {
      ...
      b._execAction('_prepTargets', 0), b.animation.animateResizeContainer &&
      ...
      for (var d = 0; d < b._$toShow.length; d++) {
        ...
        (e.style.opacity = b.effects.opacity), (e.style.display = b._changingLayout &&
          ...
          ? b._newDisplay
          : b.layout.display), f.css(c._in), b.animation.animateResizeTargets &&
          ((e.style.width = e.dataset.finalWidth + 'px'), (e.style.height =
      ...
      for (var d = 0; d < b._$pre.length; d++) {
        ...
        f.css(c), b.animation.animateResizeTargets &&
          ((e.style.width = e.dataset.origWidth + 'px'), (e.style.height =
            e.dataset.origHeight + 'px'), e.dataset.origWidth - e.dataset.finalWidth &&
            (e.style.marginRight =
              -(e.dataset.origWidth - e.dataset.interWidth) +
              1 * e.dataset.origMarginRight +
              'px'), e.dataset.origHeight - e.dataset.finalHeight &&
    ...
    _animateTargets: function() {
      ...
      b._execAction(
        ...
        .css(b._getPrefixedCSS('perspective-origin', b.animation.perspectiveOrigin)), b.animation
      ...
      for (var c = 0; c < b._$toShow.length; c++) {
        ...
        for (var i = 0; 2 > i; i++) {
          ...
          b._ff &&
            b._ff <= 20 &&
            ((h[j + 'transition-property'] = 'all'), (h[j + 'transition-timing-function'] =
              b.animation.easing + 'ms'), (h[j + 'transition-duration'] =
              b.animation.duration + 'ms')), (h[j + 'transition-delay'] = g + 'ms'), (h[
            j + 'transform'
          ] =
            'translate(' + f.x + 'px,' + f.y + 'px)');
        }
        (b.effects.transform || b.effects.opacity) && b._bindTargetDone(e), b._ff && b._ff <= 20
          ? e.css(h)
      ...
      for (var c = 0; c < b._$pre.length; c++) {
        ...
        ), e.css(b._getPrefixedCSS('transform', 'translate(' + f.x + 'px,' + f.y + 'px)')), b
          .animation.animateResizeTargets &&
          (d.dataset.origWidth - d.dataset.finalWidth &&
            1 * d.dataset.finalWidth &&
            ((d.style.width = d.dataset.finalWidth + 'px'), (d.style.marginRight =
              -(d.dataset.finalWidth - d.dataset.interWidth) +
              1 * d.dataset.finalMarginRight +
              'px')), d.dataset.origHeight - d.dataset.finalHeight &&
            1 * d.dataset.finalHeight &&
            ((d.style.height = d.dataset.finalHeight + 'px'), (d.style.marginBottom =
      ...
      for (var c = 0; c < b._$toHide.length; c++) {
        for (var d = b._$toHide[c], e = a(d), g = b._getDelay(c), k = {}, i = 0; 2 > i; i++) {
          var j = 0 === i ? (j = b._prefix) : '';
          (k[j + 'transition-delay'] = g + 'ms'), (k[j + 'transform'] =
            b.effects.transformOut), (k.opacity = b.effects.opacity);
        }
    ...
    _cleanUp: function() {
      ...
      (unBrake = function() {
        ...
        (b._changingDisplay &&
          ((b.layout.display = b._newDisplay), (b._changingDisplay = !1)), b._changingClass &&
          (b._$parent
        ...
        requestAnimationFrame(unBrake), (b._mixing = !1), 'function' == typeof b.callbacks._user &&
        b.callbacks._user.call(b._domNode, b._state, b), 'function' ==
        typeof b.callbacks.onMixEnd &&
        b.callbacks.onMixEnd.call(b._domNode, b._state, b), b._$container.trigger('mixEnd', [
        b._state,
        b
      ]), b._state.fail &&
        ('function' == typeof b.callbacks.onMixFail &&
          b.callbacks.onMixFail.call(b._domNode, b._state, b), b._$container.trigger('mixFail', [
          b._state,
          b
        ])), b._loading &&
        ('function' == typeof b.callbacks.onMixLoad &&
          b.callbacks.onMixLoad.call(b._domNode, b._state, b), b._$container.trigger('mixLoad', [
          b._state,
          b
        ])), b._queue.length &&
        (b._execAction('_queue', 0), b.multiMix(
          ...
          b._queue[0][1],
          b._queue[0][2]
        ), b._queue.splice(0, 1)), b._execAction('_cleanUp', 1), (b._loading = !1);
    },
      ...
      if ((a._execAction('multiMix', 0, arguments), a._mixing))
        a.animation.queue && a._queue.length < a.animation.queueLimit
          ? (a._queue.push(arguments), a.controls.enable &&
              !a._clicking &&
              a._updateControls(c.command), a._execAction('multiMixQueue', 1, arguments))
          : ('function' == typeof a.callbacks.onMixBusy &&
              a.callbacks.onMixBusy.call(
                a._domNode,
                a._state,
                a
              ), a._$container.trigger('mixBusy', [a._state, a]), a._execAction(
              'multiMixBusy',
              1,
              arguments
            ));
        ...
        a.controls.enable &&
          !a._clicking &&
          (a.controls.toggleFilterButtons && a._buildToggleArray(), a._updateControls(
            c.command,
            a.controls.toggleFilterButtons
          )), a._queue.length < 2 && (a._clicking = !1), delete a.callbacks._user, c.callback &&
          (a.callbacks._user = c.callback);
        var d = c.command.sort, e = c.command.filter, f = c.command.changeLayout;
        a._refresh(), d &&
          ((a._newSort = a._parseSort(
            d
          )), (a._newSortString = d), (a._sorting = !0), a._sort()), e !== b &&
          ((e = 'all' === e ? a.selectors.target : e), (a._activeFilter = e)), a._filter(), f &&
          ((a._newDisplay = 'string' == typeof f
            ? f
            : f.display || a.layout.display), (a._newClass =
            f.containerClass || ''), (a._newDisplay !== a.layout.display ||
            a._newClass !== a.layout.containerClass) &&
            ((a._changingLayout = !0), (a._changingClass =
              a._newClass !== a.layout.containerClass), (a._changingDisplay =
              a._newDisplay !== a.layout.display))), a._$targets.css(a._brake), a._goMix(
    ...
    insert: function() {
      var a = this,
        ...
        d = document.createDocumentFragment(),
        e = (function() {
          return a._refresh(), a._$targets.length
    ...
    var c,
      ...
      f = function(b, c) {
        ...
        d._execAction('_instantiate', 0, arguments), (b.id = b.id ? b.id : 'MixItUp' + e()), d
          ._instances[b.id] || ((d._instances[b.id] = d), d._init(b, c)), d._execAction(
          '_instantiate',
          1,
          arguments
        );
